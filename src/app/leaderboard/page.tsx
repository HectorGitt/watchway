...
export default function LeaderboardPage() {
	...
	const bestState = [...MOOCK_LEADERBOARD].sort(
		(a, b) => b.safety_score - a.safety_score,
	)[0];
			...
			<section className="pt-32 pb-20 px-4">
				<div className="container mx-auto max-w-5xl">
					<div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
						<div>
							<span className="text-primary font-bold tracking-wider uppercase text-sm mb-2 block animate-fade-in">
								Transparency
							</span>
							...
							<p className="text-gray-400 text-lg max-w-2xl">
								We track every report, every verify, and every
								fix. See which states are leading the way in
								infrastructure maintenance and rapid response.
							</p>
						</div>
						...
						<div className="bg-green-900/10 border border-green-500/30 p-6 rounded-2xl md:w-80 backdrop-blur-sm animate-pulse">
							...
							<div className="mt-4 text-xs text-gray-400">
								{bestState.fixed_reports} hazards resolved this
								month.
							</div>
						</div>
					</div>
					...
					<div className="mt-12 text-center p-8 bg-surface rounded-xl border border-white/5">
						...
						<p className="text-gray-400 max-w-2xl mx-auto text-sm">
							The <strong>Danger Score</strong> is a composite
							metric derived from the total number of
							unverified/unfixed hazards, the average response
							time for verified reports, and the density of "High
							Severity" ratings (e.g., collapsed bridges).
						</p>
					</div>
				</div>
			</section>
