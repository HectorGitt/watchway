...
export default function ProfilePage() {
	...
	return (
		<div className="min-h-screen bg-background text-foreground pb-20 pt-20">
			{/* Header */}
			<div className="p-4 border-b border-white/5 flex items-center justify-between sticky top-20 bg-background/90 backdrop-blur z-40">
				<button
					onClick={() => router.back()}
					...
					<div className="bg-surface border border-white/5 rounded-2xl p-6 mb-8 flex flex-col items-center text-center relative overflow-hidden">
						...
						{user.role === "citizen" && (
							<div className="mt-6 pt-6 border-t border-white/5">
								...
								<p className="text-gray-400 text-sm mb-4">
									Coordinators help verify reports and manage
									fixes in their state.
									{user.coordinator_application_status ===
									"NONE"
			...
			>
				<div className="space-y-4">
					<p className="text-sm text-gray-400">
						Coordinators play a key role in verifying hazards and
						managing community safety. By applying, you agree to:
					</p>
