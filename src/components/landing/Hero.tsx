	...
	return (
		<section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
			...
			<div className="container mx-auto px-4 relative z-10 text-center">
				{/* Live Badge */}
				<FadeIn delay={0.1}>
					<div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm hover:border-primary/50 transition-colors cursor-default">
					...
					<StaggerItem>
						<p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light">
							<span className="text-white font-medium">
								Now Live in Lagos & Ibadan.
							</span>
							<br className="hidden md:block" />
							We are building Nigeria’s first unified database of
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						...
						<Link href="/map">
							<Button
								variant="outline"
								size="lg"
								className="w-full sm:w-auto h-14 text-lg group"
							>
