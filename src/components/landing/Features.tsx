...
export function Features() {
	const features = [
		...
		},
		{
			...
			description:
				"Access our broad repository of reported infrastructure damage. Civil society organizations (CSOs) can use this data during budget defense and advocacy.",
					...
					{features.map((feature, idx) => (
						<div key={idx} className="flex flex-col items-start">
							...
							<Link href={feature.href}>
								<Button
									variant="ghost"
									className="p-0 hover:bg-transparent hover:text-primary group"
								>
									{feature.action}
